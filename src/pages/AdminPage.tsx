...
import { Plus, Pencil, Trash2, X, ShieldAlert, LogIn, LogOut } from 'lucide-react';
    ...
    return (
      <div className="container py-8 max-w-lg text-center">
        <div className="bg-card border border-border rounded-lg p-8 shadow-card">
          ...
          <p className="text-muted-foreground mb-4">
            Apenas professores da instituição com permissão de administrador podem acessar este painel.
          </p>
          <p className="text-sm text-muted-foreground mb-6">
            Você está logado como <strong>{user.nome}</strong> ({user.papel}). Se acredita que deveria ter acesso, entre em contato com a coordenação.
          </p>
          <div className="flex items-center justify-center gap-3">
            <Button
              ...
              className="gap-1.5"
            >
              <LogOut className="h-4 w-4" /> Sair e trocar conta
            </Button>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Logado como <strong>{user.nome}</strong> ({user.papel})
          </p>
        </div>
